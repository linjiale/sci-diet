<!DOCTYPE html>
<!-- saved from url=(0023)https://www.elgoog.com/ -->
<html itemscope="" itemtype="http://schema.org/WebPage" lang="zh-CN">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta content="/images/branding/elgoogg/1x/elgoogg_standard_color_128dp.png" itemprop="image">
    <link href="https://www.elgoog.com/images/branding/product/ico/elgoogg_lodp.ico" rel="shortcut icon">
    <meta content="origin" name="referrer">
    <title>elgoog</title>
    <script src="./elgoog_files/cb=gapi.loaded_0" async=""></script>
    <script nonce="AIV0DH40JWMW9Gp1Kqx5KQ==">(function () {
        window.elgoog = {
            kEI: 'svzGWsfjJsqOsQXhl6voCg',
            kEXPI: '31',
            authuser: 0,
            kscs: '6b471914_svzGWsfjJsqOsQXhl6voCg',
            u: '6b471914',
            kGL: 'US'
        };
        elgoog.kHL = 'zh-CN';
    ...
    (function () {
        elgoog.lc = [];
        elgoog.li = 0;
        elgoog.getEI = function (a) {
            for (var b; a && (!a.getAttribute || !(b = a.getAttribute("eid")));) a = a.parentNode;
            return b || elgoog.kEI
        };
        elgoog.getLEI = function (a) {
            for (var b = null; a && (!a.getAttribute || !(b = a.getAttribute("leid")));) a = a.parentNode;
            return b
        };
        elgoog.https = function () {
            return "https:" == window.location.protocol
        };
        elgoog.ml = function () {
            return null
        };
        elgoog.wl = function (a, b) {
            try {
                elgoog.ml(Error(a), !1, b)
            } catch (d) {
            }
        };
        elgoog.time = function () {
            return (new Date).getTime()
        };
        elgoog.log = function (a, b, d, c, g) {
            if (a = elgoog.logUrl(a, b, d, c, g)) {
                b = new Image;
                var e = elgoog.lc, f = elgoog.li;
                e[f] = b;
                b.onerror = b.onload = b.onabort = function () {
                    delete e[f]
                };
                elgoog.vel && elgoog.vel.lu && elgoog.vel.lu(a);
                b.src = a;
                elgoog.li = f + 1
            }
        };
        elgoog.logUrl = function (a, b, d, c, g) {
            var e = "", f = elgoog.ls || "";
            d || -1 != b.search("&ei=") || (e = "&ei=" + elgoog.getEI(c), -1 == b.search("&lei=") && (c = elgoog.getLEI(c)) && (e += "&lei=" + c));
            c = "";
            !d && elgoog.cshid && -1 == b.search("&cshid=") && (c = "&cshid=" + elgoog.cshid);
            a = d || "/" + (g || "gen_204") + "?atyp=i&ct=" + a + "&cad=" + b + e + f + "&zx=" + elgoog.time() + c;
            /^http:/i.test(a) && elgoog.https() && (elgoog.ml(Error("a"), !1, {src: a, glmm: 1}), a = "");
            return a
        };
    }).call(this);
    (function () {
        elgoog.y = {};
        elgoog.x = function (a, b) {
            if (a) var c = a.id; else {
                do c = Math.random(); while (elgoog.y[c])
            }
            elgoog.y[c] = [a, b];
            return !1
        };
        elgoog.lm = [];
        elgoog.plm = function (a) {
            elgoog.lm.push.apply(elgoog.lm, a)
        };
        elgoog.lq = [];
        elgoog.load = function (a, b, c) {
            elgoog.lq.push([[a], b, c])
        };
        elgoog.loadAll = function (a, b) {
            elgoog.lq.push([a, b])
        };
    }).call(this);
    elgoog.f = {};
    ...
    (function () {
        elgoog.c = {c: {a: true, d: true, m: true, n: false}};
        elgoog.sn = 'webhp';
        (function () {
            ...
            elgoog.timers = {};
            elgoog.startTick = function (a, b) {
                var c = b && elgoog.timers[b].t ? elgoog.timers[b].t.start : elgoog.time();
                elgoog.timers[a] = {t: {start: c}, e: {}, m: {}};
                (c = window.performance) && c.now && (elgoog.timers[a].wsrt = Math.floor(c.now()))
            };
            elgoog.tick = function (a, b, c) {
                elgoog.timers[a] || elgoog.startTick(a);
                c = void 0 !== c ? c : elgoog.time();
                b instanceof Array || (b = [b]);
                for (var d = 0; d < b.length; ++d) elgoog.timers[a].t[b[d].clearcut] = {key: b[d], ts: c}
            };
            elgoog.c.e = function (a, b, c) {
                elgoog.timers[a].e[b] = c
            };
            elgoog.c.b = function (a) {
                var b = elgoog.timers.load.m;
                b[a] && elgoog.wl("ch_mab", {m: a});
                b[a] = !0
            };
            elgoog.c.u = function (a) {
                var b = elgoog.timers.load.m;
                if (b[a]) {
                    b[a] = !1;
                    for (a in b) if (b[a]) return;
                    elgoog.csiReport()
                } else elgoog.wl("ch_mnb", {m: a})
            };
            elgoog.rll = function (a, b, c) {
                var d = function (b) {
                    c(b);
                    e(a, "load", d);
                    e(a, "error", d)
            ...
            elgoog.afte = !0;
            elgoog.aft = function (a) {
                elgoog.c.c.a && elgoog.afte && (elgoog.timers.aft || elgoog.startTick("aft"), elgoog.timers.aft.t[a.id || a.src || a.name] = elgoog.time())
            };
            elgoog.startTick("webaft");
            elgoog.startTick("load");
            elgoog.c.b("pr");
            elgoog.c.b("xe");
        }).call(this);
    })();
    ...
    ;(function () {
        ...
        O(Z, "speech");
        (function (a) {
            elgoog.jsad = function (d) {
                Y(a, d)
            };
            elgoog.jsaac = function (d) {
                return V(a, d)
            };
            elgoog.jsarc = function (d) {
                X(d);
    ...
    .gbii::before {
        content: url(https://lh3.elgoogusercontent.com/-uqx0N6Utxi8/AAAAAAAAAAI/AAAAAAAAAAA/ACLGyWAClMsWIv9rWtifKDqc4plOaPBMsA/s32-c-mo/photo.jpg)
    }

    .gbip::before {
        content: url(https://lh3.elgoogusercontent.com/-uqx0N6Utxi8/AAAAAAAAAAI/AAAAAAAAAAA/ACLGyWAClMsWIv9rWtifKDqc4plOaPBMsA/s96-c-mo/photo.jpg)
    }

    @media (min-resolution: 1.25dppx),(-o-min-device-pixel-ratio: 5/4),(-webkit-min-device-pixel-ratio: 1.25),(min-device-pixel-ratio: 1.25) {
        .gbii::before {
            content: url(https://lh3.elgoogusercontent.com/-uqx0N6Utxi8/AAAAAAAAAAI/AAAAAAAAAAA/ACLGyWAClMsWIv9rWtifKDqc4plOaPBMsA/s64-c-mo/photo.jpg)
        }

        .gbip::before {
            content: url(https://lh3.elgoogusercontent.com/-uqx0N6Utxi8/AAAAAAAAAAI/AAAAAAAAAAA/ACLGyWAClMsWIv9rWtifKDqc4plOaPBMsA/s192-c-mo/photo.jpg)
        }
    }

    .gbii {
        background-image: url(https://lh3.elgoogusercontent.com/-uqx0N6Utxi8/AAAAAAAAAAI/AAAAAAAAAAA/ACLGyWAClMsWIv9rWtifKDqc4plOaPBMsA/s32-c-mo/photo.jpg)
    }

    .gbip {
        background-image: url(https://lh3.elgoogusercontent.com/-uqx0N6Utxi8/AAAAAAAAAAI/AAAAAAAAAAA/ACLGyWAClMsWIv9rWtifKDqc4plOaPBMsA/s96-c-mo/photo.jpg)
    }

    @media (min-resolution: 1.25dppx),(-o-min-device-pixel-ratio: 5/4),(-webkit-min-device-pixel-ratio: 1.25),(min-device-pixel-ratio: 1.25) {
        .gbii {
            background-image: url(https://lh3.elgoogusercontent.com/-uqx0N6Utxi8/AAAAAAAAAAI/AAAAAAAAAAA/ACLGyWAClMsWIv9rWtifKDqc4plOaPBMsA/s64-c-mo/photo.jpg)
        }

        .gbip {
            background-image: url(https://lh3.elgoogusercontent.com/-uqx0N6Utxi8/AAAAAAAAAAI/AAAAAAAAAAA/ACLGyWAClMsWIv9rWtifKDqc4plOaPBMsA/s192-c-mo/photo.jpg)
        }
    }
    </style>
    <style data-jiis="cc" id="gstyle">html, body {
        height: 100%;
        margin: 0
    }
    ...
    #tags.lst-d-f, #tags:hover.lst-d-f {
    ...
    <script nonce="AIV0DH40JWMW9Gp1Kqx5KQ==">(function () {
        ...
        var c = [function () {
            elgoog.c && elgoog.tick("load", b)
        }];
        elgoog.dclc = function (a) {
            c.length ? c.push(a) : a()
        };
    ...
    (window['gbar'] = window['gbar'] || {})._CONFIG = [[[0, "www.gstatic.com", "og.og2.en_US.DsHOofbGMmQ.O", "com", "zh-CN", "1", 0, [3, 2, ".40.", "", "1300102,3700290,3700440,3700521", "190405948", "0"], "40400", "svzGWsnAKKq8tgXi5qrwAQ", 0, 0, "og.og2.-tuj17gvk771w.L.W.O", "AA2YrTunYyhQXRvVKqTSwejvoR73Wu4Flw", "AA2YrTtiNzOtZjnIikyJqABiuUN4SycHzA", "", 2, 0, 200, "USA", null, null, "1", "1", 0], ["", "https", "notifications.elgoog.com", "", "/u/0/widget", "sourceid=1", "pid=1", "zh-CN", 5, "https://accounts.elgoog.com/ServiceLogin?hl=zh-CN\u0026passive=true\u0026continue=https://www.elgoog.com/", 1, 30000, null, "%1$s重新加载页面%2$s，然后重试。", "111839813429439323681", ""], 0, ["m;/_/scs/abc-static/_/js/k=gapi.gapi.en.wjAGE-AVlTo.O/m=__features__/am=AAE/rt=j/d=1/rs=AHpOoo-gY863zTybf8wCUIW8gIU8UfC49g", "https://apis.elgoog.com", "", "", "1", "", null, 1, "es_plusone_gc_20180321.0_p0", "zh-CN"], ["1", "gci_91f30755d6a6b787dcc2a4062e6e9824.js", "elgoogapis.client:plusone:gapi.iframes", "0", "zh-CN"], null, [100, "通知", 1, "https", "notifications.elgoog.com", "", 0, "", "POST", "/u/0/_/notifications/count", 3000, "%1$s 条 elgoog 通知", 1, "加载通知时出错。", "ogs.elgoog.com"], null, [0.009999999776482582, "com", "1", [null, "", "w", null, 1, 5184000, 1, 0, "", 0, 1, "", 0, 0, null, 0], null, [["", "", "0", 0, 0, -1]], null, 0, null, null, ["5061451", "elgoog\\.(com|ru|ca|by|kz|com\\.mx|com\\.tr)$", 1]], ["%1$s（默认）", "品牌帐号", 0, "%1$s（已授权）", 1, null, 96, "https://www.elgoog.com/webhp?authuser=$authuser", null, null, null, 1, "https://accounts.elgoog.com/ListAccounts?listPages=0\u0026pid=1\u0026gpsia=1\u0026source=ogb\u0026mo=1\u0026mn=1\u0026hl=zh-CN", 0, "dashboard", null, null, null, null, "个人资料", "", 0, null, "未登录", "https://accounts.elgoog.com/AccountChooser?source=ogb\u0026continue=$continue\u0026Email=$email", "https://accounts.elgoog.com/RemoveLocalAccount?source=ogb\u0026Email=$email", "移除", "登录", 0, 0, 1, 0, 1, 0, 0, "000770F20355B54717419C340AB3DBFF869B95EB5BFA51EFBD::1522990258667"], [1, 0, 0, null, "0", "674481877@qq.com", "", "AB0kaiJZsyA1QENJ89-wtbvujVZZdUYulpGrTrxBDQ6XTJaqsRJLwJFNZkQ4NVHN0A4D98btK4wfXPrRz4ggS9-4YLjMKK0DGg"], [1, 0.001000000047497451, 1], [1, 0.1000000014901161, 2, 1], [0, "", null, "", 0, "加载您的 Marketplace 应用时出错。", "您没有任何 Marketplace 应用。", 1, [1, "https://www.elgoog.com/webhp?tab=ww", "搜索", "", "0 -483px", null, 0], null, null, null, 0, [[1, "第 %1$s 个应用，共 %2$s 个", "“更多”部分中的第 %1$s 个应用，共 %2$s 个"]], null, 0], [1], [0, 1, ["lg"], 1, ["lat"]], [["", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "drt", "def", "", "", "", "", "", "", "", "", ""], [""]], null, null, [1, null, null, "[[]]", ["https", "ogs.elgoog.com", 0, "/u/0", "rt=j\u0026sourceid=1", ["/u/0/_/og/customization/get", ""], ["/u/0/_/og/customization/set", ""], ["/u/0/_/og/customization/remove", ""]], "AB0kaiJZsyA1QENJ89-wtbvujVZZdUYulpGrTrxBDQ6XTJaqsRJLwJFNZkQ4NVHN0A4D98btK4wfXPrRz4ggS9-4YLjMKK0DGg"], [30, 127, 1, 0, 60], null, null, null, ["https", "clients5.elgoog.com", "", "pagead/drt/dn/"], null, [1, 0], null, [1, 0.1000000014901161, 0, 40400, 1, "USA", "zh-CN", "190405948.0", 1, 0.001000000047497451], null, [""]]];
    ...
    <script async="" type="text/javascript" charset="UTF-8"
            src="./elgoog_files/rs=AA2YrTunYyhQXRvVKqTSwejvoR73Wu4Flw"></script>
    <link rel="stylesheet" type="text/css" href="./elgoog_files/rs=AA2YrTtiNzOtZjnIikyJqABiuUN4SycHzA">
    <script async="" type="text/javascript" charset="UTF-8"
            src="./elgoog_files/rs=AA2YrTunYyhQXRvVKqTSwejvoR73Wu4Flw(1)"></script>
...
<body class="hp vasq"
      onload="document.f&amp;&amp;document.f.q.focus();document.gbqf&amp;&amp;document.gbqf.q.focus();if(document.images)new Image().src=&#39;/images/nav_logo242.png&#39;"
      id="gsr">
<div class="ctr-p" id="viewport">
    ...
    <style>@media only screen and (max-width: 580px) {
        #gb div {
            display: none
        }
    }</style>
    <div class="jhp big" id="searchform">
        ...
        <form class="tsf" action="https://www.elgoog.com/search" style="overflow:visible" id="tsf" method="GET" name="f"
              onsubmit="return q.value!=&#39;&#39;" role="search">
            <div id="tophf"><input name="source" type="hidden" value="hp"><input value="svzGWsfjJsqOsQXhl6voCg"
                                                                                 name="ei" type="hidden"></div>
            <div class="tsf-p">
                <div class="nojsv logocont" id="logocont"><h1><a
                        href="https://www.elgoog.com/webhp?hl=zh-CN&amp;sa=X&amp;ved=0ahUKEwjHhPPq7KTaAhVKR6wKHeHLCq0QPAgD"
                        title="elgoog 首页" id="logo" data-hveid="3"><img
                        src="./elgoog_files/elgooglogo_color_120x44dp.png" alt="elgoog" height="44" width="120"
                        onload="typeof elgoog===&#39;object&#39;&amp;&amp;elgoog.aft&amp;&amp;elgoog.aft(this)"></a>
                </h1></div>
                <div class="sfibbbc">
                    <div class="sbtc" id="sbtc">
                        <div class="sbibtd">
                            ...
                            <div class="sbibod " id="sfdiv">
                                <button class="sbico-c" value="elgoog 搜索" aria-label="elgoog 搜索" id="mKlEF" name="btnG"
                                            ...
                                            <div id="chmo">
                                                <div id="chm">
                                                    ...
                                                    <div style="display: none;">
                                                        <div class="chma"></div>
                                                        <div>发生错误，无法收听。</div>
                                                        <div><a>重新启动收听</a><a style="padding-left: 10px;">帮助</a></div>
                                                    </div>
                                                    <div style="display: none;">启动指令检测功能已关闭。
                                                        <div><a>开始收听“Ok elgoog”指令</a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="gstl_0 sbdd_a"
                             style="display: none; min-width: 584px; top: 44px; position: absolute; left: 0px;">
                            <div class="fl"></div>
                            <div>
                    ...
                    <div>
                        <div id="pocs" style="display:none;left:0px;white-space:nowrap;position:absolute">
                            <div id="pocs0"><span><span>elgoog</span> 即搜即得不可用。请按回车键进行搜索。</span>&nbsp;<a
                                    href="https://support.elgoog.com/websearch/answer/186645?hl=zh-CN">了解详情</a></div>
                            <div id="pocs1">由于网速慢，<span>elgoog</span> 即搜即得已关闭。请按回车键进行搜索。</div>
                            <div id="pocs2">按回车键进行搜索。</div>
                        </div>
                    </div>
                </div>
                <div class="jsb" style="padding-top:18px">
                    <center><input value="elgoog 搜索" aria-label="elgoog 搜索" name="btnK" type="submit" onclick="search();return false;" jsaction="sf.chk">
                </div>
            </div>
            <div id="sbfbl" style="display:none"
                ...
                <div style="display:none" jsl="$t t-aTz9-_sUcEc;$x 0;" class="r-iIM2dtbw5Ysg"></div>
                <div id="duf3-46" data-jiis="up" data-async-type="duffy3"
                     ...
                     class="y yp" data-ved="0ahUKEwjHhPPq7KTaAhVKR6wKHeHLCq0Q-0EIBA"></div>
                <a class="duf3 aciXEb" href="https://www.elgoog.com/#" id="sbfblt" data-async-trigger="duf3-46"
                   jsaction="async.u" data-ved="0ahUKEwjHhPPq7KTaAhVKR6wKHeHLCq0Qtw8IBQ">举报不当的联想查询</a></div>
            <input type="hidden" name="oq" value=""><input type="hidden" name="gs_l" value=""></form>
    </div>
    <div class="sfbgx"></div>
            ...
            <div class="spchc" id="spchc">
                <div class="D449Nc">
                    <div class="Q05LFe"><span class="r8s4j" id="spchl"></span><span class="button" id="spchb"><div
                            class="H1aTHf"><span class="fcn9Hf"></span><div class="sM5MNb"><span
                            class="Aax87c"></span><span class="ae3xF"></span></div></div></span></div>
                    <div class="otCIDb"><span class="spcht" id="spchi" style="color:#777"></span><span class="spcht"
                                                                                                       id="spchf"
                                                                                                       style="color:#000"></span>
                    </div>
                    <div class="elgoog-logo"></div>
                </div>
                <div class="GuIecd">
                    <div class="bQ9ks"></div>
                </div>
    ...
    <div>
        <div style="display:none" jsl="$t t-orNZyHXTT74;$x 0;" class="r-i7DhUGBacyfU"></div>
    </div>
    <div class="content" id="main"><span class="ctr-p" id="body"><center><div style="height:233px;margin-top:89px"
                                                                              id="lga"><img alt="elgoog" height="92"
                                                                                            id="hplogo"
                                                                                            src="../file/elgoog.png"
                                                                                            srcset="../file/elgoog.png 1x, ../file/elgoog.png 2x"
                                                                                            style="padding-top:109px"
                                                                                            width="272"
                                                                                            onload="window.lol&amp;&amp;lol()"></div><div
            style="height:118px"></div><div id="prm-pt" style="margin-top:12px"><script
            nonce="AIV0DH40JWMW9Gp1Kqx5KQ==">window.gbar && gbar.up && gbar.up.tp && gbar.up.tp();</script><div
            id="als"><style>#als {
        font-size: small;
        margin-bottom: 24px
    }
    ...
    .FoqEvd {
        ...
        <div id="footc">
            <div id="xfoot">
                <div id="xjsd">
                    <script src="./elgoog_files/rs=ACT90oGSOuCbN8ZsuNecttrT63enyqbpPg"></script>
                </div>
                <div id="xjsi">
                    <script nonce="AIV0DH40JWMW9Gp1Kqx5KQ==">(function () {
                        function c(b) {
                            window.setTimeout(function () {
                                ...
                                a.src = b;
                                elgoog.timers && elgoog.timers.load.t && elgoog.tick("load", {
                                    gen204: "xjsls",
                                    clearcut: 31
                                });
                    ...
                    if (!elgoog.xjs) {
                        ...
                        elgoog.dljp('/xjs/_/js/k\x3dxjs.s.zh_CN.IRw7V10SnE8.O/m\x3dsx,sb,cdos,cr,elog,hsm,jsa,r,d,csi/am\x3dwCJ0xz8A-f8DA4pEKxhhAUwLhqEB/rt\x3dj/d\x3d1/t\x3dzcms/rs\x3dACT90oH45K1ywqb7FB5jK1krivVqh_kH6Q', '/xjs/_/js/k\x3dxjs.s.zh_CN.PV-0RDwspnk.O/m\x3dsx,sb,cdos,cr,elog,hsm,jsa,r,d,csi/am\x3dwCJ0xz8A-f8DA4pEKxhhAUwLhqEB/rt\x3dj/d\x3d1/t\x3dzcms/rs\x3dACT90oGSOuCbN8ZsuNecttrT63enyqbpPg');
                        elgoog.xjs = 1;
                    }
                    elgoog.pmc = {
                        "sx": {},
                        "sb": {
                            ...
                            "msgs": {
                                ...
                                "chh": "请说“Ok elgoog”",
                                "cht": "启动指令检测功能已关闭。",
                                "chtr": "开始收听“Ok elgoog”指令",
                                "chtt": "正在收听“Ok elgoog”指令",
                                "cibl": "清除搜索",
                                "dym": "您是不是要找：",
                                "flf": "举报不当的联想查询",
                                "lcky": "\u0026nbsp;手气不错\u0026nbsp;",
                                "lml": "了解详情",
                                "oskt": "输入工具",
                                "psrc": "该搜索记录已从您的\u003Ca href=\"/history\"\u003E网络历史记录\u003C/a\u003E中移除",
                                "psrl": "删除",
                                "sbit": "按图片搜索",
                                "srch": "elgoog 搜索",
                                "srtt": "按语音搜索"
                            ...
                            "sce": 4,
                            "sre": true,
                            "stok": "god_DpUVRj7y2qADQZol4l_HQNM",
                            "token": "rao5FGME3o48FnqUHQTVbg",
                        ...
                        "elog": {},
                        "foot": {"pf": true, "po": false, "qe": false},
                        "fpe": {"js": true},
                        "gf": {"pid": 196, "si": true},
                        "hsm": {},
                        "ipv6": {},
                        ...
                        "mu": {"murl": "https://adservice.elgoog.com/adsid/elgoog/ui"},
                        "r": {},
                        "sf": {},
                        "sonic": {},
                        "spch": {
                            "ae": "请检查您的麦克风。\u003Ca href=\"https://support.elgoog.com/chrome/?p=ui_voice_search\" target=\"_blank\"\u003E了解详情\u003C/a\u003E",
                            "hl": "zh-Hans-US",
                            "im": "点击\u003Cb\u003E允许\u003C/b\u003E开始语音搜索",
                            "iw": "正在等待...",
                            "lm": "正在收听…",
                            "lu": "目前尚未提供%1$s版语音搜索服务",
                            "ne": "未连接到互联网",
                            "nt": "不确定所说内容，\u003Cspan\u003E请重试\u003C/span\u003E",
                            "nv": "请检查您的麦克风和音频电平。\u003Ca href=\"https://support.elgoog.com/chrome/?p=ui_voice_search\" target=\"_blank\"\u003E了解详情\u003C/a\u003E",
                            "pe": "语音搜索功能处于关闭状态。\u003Ca href=\"https://support.elgoog.com/chrome/?p=ui_voice_search\" target=\"_blank\"\u003E详细信息\u003C/a\u003E",
                            "rm": "请开始说话"
                        },
                        "d": {},
                    ...
                    elgoog.plm(['aa', 'abd', 'async', 'dvl', 'foot', 'fpe', 'ipv6', 'lu', 'm', 'mu', 'sf', 'sonic', 'spch']);
                    elgoog.x(null, function () {
                    });
                    (function () {
                        var r = ['d3l', 'udlg'];
                        elgoog.plm(r);
                    ...
                    (function () {
                        var ctx = ["root", [["t-aTz9-_sUcEc", "iIM2dtbw5Ysg", "r-iIM2dtbw5Ysg"]
                                    , ["t-orNZyHXTT74", "i7DhUGBacyfU", "r-i7DhUGBacyfU", [["update_uule_on_visibility_change_events", null, null, null, null, [null, null, null, null, 0]
                                    ]
                                        , ["js_config", null, null, null, null, [null, "[null,null,1,30000,null,null,null,2,null,null,3,null,null,null,null,null,1,null,null,null,null,null,null,null,null,null,null,null,0,null,null,null,null,null,null,null,null,\"1522990258\",null,null,null,null,null,1,\"86400000\",null,[\"86400000\",\"604800000\",2.0]\n]\n"]
                                        ]
                                    ]
                                    ]
                                ]
                                ]
                        ;elgoog.jsc && elgoog.jsc.x(ctx);
                    })();
                    (function () {
                        var m = [];
    ...
    <script nonce="AIV0DH40JWMW9Gp1Kqx5KQ==">/* _GlobalPrefix_ */
    this.gbar_ = this.gbar_ || {};
    (function (_) {
        var window = this;
        /* _Module_:sy6 */
        ...
        try {
            ...
            var ej = function (a) {
                a.G || (a.G = .005 > a.ia() ? "https://www.elgoog.com/log?format=json" : "https://play.elgoog.com/log?format=json");
                return a.G
            };
            ...
            var jj = [1], kj = function (a, c, d) {
                ...
                if (this.A || this.o) a = _.F(a, 3) ? "https://jmt17.elgoog.com/log" : void 0, c = this.b = new _.ij(373, _.J(_.F(c, 5)), a), c.P = !0, fj(c, 1E3), this.b.$ = !!_.si().navigator.sendBeacon && _.Eb, _.th(this,
                        this.b)
            };
            _.y(kj, _.z);
        ...
        try {
            ...
            _.yj = function (a) {
                var c = window.elgoog && window.elgoog.logUrl ? "" : "https://www.elgoog.com";
                c += "/gen_204?";
                c += a.o(2040 - c.length);
                xj(c)
            };
            ...
            var Bj = function (a, c) {
                ...
                this.data.ei = window.elgoog && window.elgoog.kEI ? window.elgoog.kEI : _.J(_.F(a, 10));
                this.data.ogf = _.J(_.F(d, 3));
                var e = window.elgoog && window.elgoog.sn ? /.*hp$/.test(window.elgoog.sn) ? !1 : !0 : _.I(_.F(a, 7));
                this.data.ogrp = e ? "1" : "";
...
*/
        ...
        try {
            ...
            var $n = {key: "ok", caption: "OK"}, ao = {key: "cancel", caption: "Cancel"},
                    bo = {key: "yes", caption: "Yes"}, co = {key: "no", caption: "No"},
                    eo = {key: "save", caption: "Save"}, fo = {key: "continue", caption: "Continue"};
            ...
            _.Of(_.fc("//www-onepick-opensocial.elgoogusercontent.com/gadgets/js/rpc.js?c=1&container=onepick"));
            _.Of(_.fc("//apis.elgoog.com/js/rpc.js"));
        } catch (e) {
            _._DumpException(e)
        }
        /* _Module_:syj */
    ...
    <script nonce="AIV0DH40JWMW9Gp1Kqx5KQ==">(function () {
        var l = false;
        var f = {gen204: "aft", clearcut: 1}, g = {gen204: "iml", clearcut: 8}, k = {gen204: "ol", clearcut: 14},
        ...
        function A(a) {
            ++t;
            a = a || window.event;
            elgoog.timers.iml || elgoog.startTick("iml");
            var b = elgoog.time();
            elgoog.tick("load", g, b);
            a = a.target || a.srcElement;
            a = a.id || a.src || a.name;
            elgoog.timers.iml.t[a] = b;
            elgoog.c.c.a && (elgoog.timers.aft.t[a] = b)
        }

        var B = function () {
            var a = elgoog.timers.webaft, b = a.t, d = b.start;
            a = {wsrt: a.wsrt};
            ...
            var b = "/gen_204?s=webaft&atyp=csi&ei=" + elgoog.kEI + "&rt=", d = "", c;
            for (c in a) b += d + c + "." + a[c], d = ",";
            elgoog.cshid && (b += "&cshid=" + elgoog.cshid);
            (a = window.performance && window.performance.navigation) &&
            2 == a.type && (b += "&bb=1");
            return b
        }, D = function () {
            var a = B(), b = C(a), d = function () {
                q ? (q.setAttribute("ping", b), q.click()) : navigator.sendBeacon ? navigator.sendBeacon(b, "") : elgoog.log("", "", b)
            }, c = a.gsasrt || a.wsrt;
            a = a[f.gen204];
            0 <= elgoog.c.c.t && c && a ? setTimeout(d, elgoog.c.c.t * (c + a)) : d()
        }, E = function (a) {
            ++v;
            x[a.id] || (x[a.id] = 0);
            x[a.id]++;
            elgoog.rll(a, !1, function () {
                elgoog.aftd(a.id)
            })
        };
        elgoog.aftl = function (a) {
            x[a.id] && E(a)
        };
        elgoog.aftd = function (a) {
            if (x[a]) {
                ++w;
                if (w == v) {
                    var b = elgoog.time();
                    elgoog.tick("webaft", f, b);
                    elgoog.tick("load", f, b);
                    D()
                }
                --x[a]
            }
        ...
        (function (a) {
            if (elgoog.timers && elgoog.timers.load.t) {
                elgoog.tick("load", [m, g]);
                elgoog.tick("webaft", m);
                elgoog.c.pprt || (elgoog.tick("load", f), elgoog.tick("webaft", f));
                (q = document.getElementById("csi-ping")) && q.addEventListener("click", z);
                elgoog.c.c.a && (elgoog.startTick("aft"), elgoog.afte = !1);
                var b = document.getElementsByTagName("img");
                r = b.length;
                for (var d = t = 0, c; c = b[d]; ++d) {
                    var h = "string" != typeof c.src || !c.src, e = h || c.complete;
                    if (c.hasAttribute("data-noaft")) e = !0; else if (elgoog.c.c.d) {
                        var n = c.id;
                        elgoog.ldi &&
                        n && elgoog.ldi[n] ? (a && (e = !1), c.setAttribute("lazy-loaded", ""), c.removeAttribute("data-deferred")) : c.getAttribute("data-deferred") ? e = !1 : (h || "data:image/gif;base64,R0lGODlhAQABAIAAAP///////yH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" == c.src) && c.setAttribute("lazy-loaded", "")
                    } else elgoog.c.c.m && h && c.getAttribute("data-bsrc") && (e = !1);
                    e ? ++t : (elgoog.rll(c, !0, A), p(c) && E(c))
                }
                u = r - t;
                elgoog.rll(window, !1, function () {
                    elgoog.tick("load", k);
                    elgoog.c.e("load", "imc", String(t));
                    elgoog.c.e("load", "imn", String(r));
                    elgoog.c.e("load", "imp", String(u));
                    elgoog.c.u("pr")
                });
                v || D()
            }
            elgoog.c.c.n && document.getElementsByClassName("native_iml_flag").length && elgoog.c.b("ncr")
        })(l);
    })();</script>
    <div id="lfootercc"></div>
</div>
<script src="./elgoog_files/rs=ACT90oH45K1ywqb7FB5jK1krivVqh_kH6Q" async="" gapi_processed="true"></script>
<iframe src="./elgoog_files/saved_resource.html" aria-hidden="true" style="display: none;"></iframe>
</body>
</html>
<script>
    function search(){
